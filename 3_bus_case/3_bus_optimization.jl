...
gas = ThermalStandard(;
    ...
    active_power_limits = (min = 0.0, max = 1.0), # 6 MW to 30 MW per-unitized by device base_power
...
plot(time_line1,data_dispatch_wind, xrotation = 90, xlabel="Time", ylabel="Power (MW)", label="wind", ylims = (-100.0,150.0))
